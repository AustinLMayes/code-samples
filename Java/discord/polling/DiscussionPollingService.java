package net.avicus.hook.discord.polling;

import java.awt.Color;
import java.util.Arrays;
import java.util.logging.Logger;
import lombok.Getter;
import net.avicus.hook.discord.Main;
import net.avicus.magma.core.database.Database;
import net.avicus.magma.core.database.model.impl.Discussion;
...
public class DiscussionPollingService extends PollingService<Discussion> {
  ...
  MessageEmbed getAlertMessage(Discussion discussion) {
    ...
    return new MessageEmbedImpl()
        ...
        .setUrl("https://avicus.net/forums/discussions/" + discussion.getUuid());
  }
}
